...
// Код формы
$iAdmin_Form_Id = 318;
$sFormAction = '/admin/shop/discountcard/bonus/type/index.php';
...
$sFormTitle = Core::_('Shop_Discountcard_Bonus_Type.title');
...
{
	$Shop_Discountcard_Bonus_Type_Controller_Edit = Admin_Form_Action_Controller::factory(
		'Shop_Discountcard_Bonus_Type_Controller_Edit', $oAdmin_Form_Action_Edit
	);
	$Shop_Discountcard_Bonus_Type_Controller_Edit->addEntity($oAdmin_Form_Entity_Breadcrumbs);
	$oAdmin_Form_Controller->addAction($Shop_Discountcard_Bonus_Type_Controller_Edit);
}
...
$oAdmin_Form_Dataset = new Admin_Form_Dataset_Entity(
	Core_Entity::factory('Shop_Discountcard_Bonus_Type')
);
