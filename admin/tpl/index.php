...
// Действие "Экспорт"
$oAdminFormActionExportTpl = Core_Entity::factory('Admin_Form', $iAdmin_Form_Id)
	->Admin_Form_Actions
	->getByName('exportTpls');
...
if (strlen($sGlobalSearch))
{
	$oAdmin_Form_Dataset
		->addCondition(array('open' => array()))
			->addCondition(array('where' => array('tpl_dirs.id', '=', $sGlobalSearch)))
...
if (strlen($sGlobalSearch))
{
	$oAdmin_Form_Dataset
		->addCondition(array('open' => array()))
			->addCondition(array('where' => array('tpls.id', '=', $sGlobalSearch)))
			->addCondition(array('setOr' => array()))
