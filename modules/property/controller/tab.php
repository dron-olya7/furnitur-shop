...
class Property_Controller_Tab extends Core_Servant_Properties
{
	...
	*/
	protected function _setPropertyDirs($property_dir_id, $parentObject)
	{
		...
		if ($property_dir_id == 0 && count($this->_property_values))
		{
			...
			{
				$this->_addIntoSection($oAdmin_Form_Entity_Panel, Core_Entity::factory('Property', $property_id), FALSE);
			}
		}
	...
	protected function _addIntoSection($oAdmin_Form_Entity_Panel, $oProperty, $active = TRUE)
	{
		...
		$oAdmin_Form_Entity_Panel->add(
			$oAdmin_Form_Entity_Section = Admin_Form_Entity::factory('Div')
				->class('section-' . $oProperty->id . ($active ? '' : ' section-inactive'))
		);
			...
			case 5: // ИС
				if (Core::moduleIsActive('informationsystem'))
				{
					...
					$oAdmin_Form_Entity_InfGroups = Admin_Form_Entity::factory('Select')
						...
						->class('form-control disable-restore')
						->filter(TRUE);
		...
		{
			$windowId = $this->_Admin_Form_Controller->getWindowId();
			$oAdmin_Form_Entity_Section->add(Core_Html_Entity::factory('Script')->value("$.applyPropertySectionSortable('{$windowId}', '{$oProperty->id}');"));
		}
	...
	protected function _fillList($value, $oProperty, $oAdmin_Form_Entity_Section, $oAdmin_Form_Entity_ListItemsSelect, $oAdmin_Form_Entity_ListItemsInput, $oAdmin_Form_Entity_Autocomplete_Select)
	{
		...
		// Autocomplete should always be added. When copied, the 'id_property' may contain 'id_property_clone'
		$oDiv_Group->add(
			//Core_Html_Entity::factory('Script')->value("$.applyListItemAutocomplete('{$windowId}', 'id_property_{$oProperty->id}', '{$oList->id}');")
			Core_Html_Entity::factory('Script')->value("$.applyListItemAutocomplete('{$windowId}', '{$oAdmin_Form_Entity_ListItemsInput->id}', '{$oList->id}');")
		);
	...
	protected function _fillInformationSystemGroup($value, $oProperty, $oAdmin_Form_Entity_Section, $oAdmin_Form_Entity_InfGroups, $oAdmin_Form_Entity_InfGroupsInput)
	{
		...
		$oDiv_Group->add(
			Core_Html_Entity::factory('Script')->value("$.applyInformationsystemGroupAutocomplete('{$windowId}', '{$oProperty->id}', '{$oInformationsystem->id}');")
		);
	...
	*/
	protected function _fillInformationSystem($value, $oProperty, $oAdmin_Form_Entity_Section, $oAdmin_Form_Entity_InfGroups, $oAdmin_Form_Entity_InfItemsSelect, $oAdmin_Form_Entity_InfItemsInput)
	{
		...
		// autocomplete should be added always
		$oDiv_Group->add(
			Core_Html_Entity::factory('Script')->value("$.applyInformationsystemItemAutocomplete('{$windowId}', '{$oProperty->id}', '{$oInformationsystem->id}');")
		);
	...
	protected function _fillShopGroup($value, $oProperty, $oAdmin_Form_Entity_Section, $oAdmin_Form_Entity_Shop_Groups, $oAdmin_Form_Entity_Shop_Groups_Input)
	{
		...
		// autocomplete should be added always
		$oDiv_Group->add(
			Core_Html_Entity::factory('Script')->value("$.applyShopGroupAutocomplete('{$windowId}', '{$oProperty->id}', '{$oShop->id}');")
		);
	...
	*/
	protected function _fillShop($value, $oProperty, $oAdmin_Form_Entity_Section, $oAdmin_Form_Entity_Shop_Groups, $oAdmin_Form_Entity_Shop_Items, $oAdmin_Form_Entity_Shop_Items_Input)
	{
		...
		// autocomplete should be added always
		$oDiv_Group->add(
			Core_Html_Entity::factory('Script')->value("$.applyShopItemAutocomplete('{$windowId}', '{$oProperty->id}', '{$oShop->id}');")
		);
