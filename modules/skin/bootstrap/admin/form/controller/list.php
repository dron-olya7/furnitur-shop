									...
									foreach ($aAdmin_Form_Fields as $oAdmin_Form_Field)
									{
										...
										if ($oAdmin_Form_Field_Changed->allow_filter && $oAdmin_Form_Field_Changed->view != 2 || $oAdmin_Form_Field_Changed->view == 1)
										{
											...
											if (!is_null($fieldName))
											{
												...
												$filter_condition = isset($oAdmin_Form_Field_Changed->filter_condition) // remove after 7.0.7
													? $oAdmin_Form_Field_Changed->filter_condition
													: 0;
												?><div class="form-group" id="<?php echo htmlspecialchars($sFormGroupId)?>">
													...
													<div class="col-sm-10">
														<div class="row">
															...
															?>
															<div class="<?php echo $filter_condition ? 'col-xs-10 col-md-11' : 'col-sm-12'?>">
																<?php
