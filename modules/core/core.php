...
class Core
{
	...
	static public function mainConfig()
	{
		...
		self::$mainConfig = self::$config->get('core_config') + array(
			...
			'availableExtension' => array('JPG', 'JPEG', 'GIF', 'PNG', 'SVG', 'WEBP', 'AVIF', 'PDF', 'ZIP', 'DOC', 'DOCX', 'XLS', 'XLSX'),
			'availableGetVariables' => array('_openstat', 'utm_source', 'gclid', 'yclid', 'ymclid', 'ysclid', 'yadclid', 'fbclid', 'yadordid', 'from'),
			'defaultCache' => 'file',
