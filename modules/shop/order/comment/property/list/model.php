 ...
 */
class Shop_Order_Comment_Property_List_Model extends Shop_Model
{
	/**
	 * Name of the table
	 * @var string
	 ...
	 * @var string
	 */
	protected $_modelName = 'shop_order_comment_property_list';
	...
	protected $_hasMany = array(
		'property' => array(
			'through' => 'shop_order_comment_property',
			'foreign_key' => 'shop_id',
			'dependent_key' => 'property_id'
		),
		'property_dir' => array(
			'through' => 'shop_order_comment_property_dir',
			'foreign_key' => 'shop_id',
	...
	{
		return 'order_comment_property_' . $oFileValue->id . '.' . Core_File::getExtension($originalFileName);
	}
	...
	{
		return 'small_order_comment_property_' . $oFileValue->id . '.' . Core_File::getExtension($originalFileName);
	}
