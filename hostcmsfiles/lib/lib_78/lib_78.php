...
if (!Core::moduleIsActive('helpdesk'))
{
	...
	<p>Модуль &laquo;<a href="https://www.hostcms.ru/hostcms/modules/helpdesk/">Системы обработки запросов</a>&raquo; доступен в редакции &laquo;<a href="https://www.hostcms.ru/hostcms/editions/corporation/">Корпорация</a>&raquo;.</p>
	<?php
	return ;
}
