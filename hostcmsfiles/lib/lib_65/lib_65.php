...
if (!Core::moduleIsActive('forum'))
{
	...
	<p>Модуль &laquo;<a href="https://www.hostcms.ru/hostcms/modules/forums/">Форумы</a>&raquo; доступен в редакции &laquo;<a href="https://www.hostcms.ru/hostcms/editions/corporation/">Корпорация</a>&raquo;.</p>
	<?php
	return ;
}
