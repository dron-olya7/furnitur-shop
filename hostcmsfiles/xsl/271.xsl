...
<!DOCTYPE xsl:stylesheet SYSTEM "lang://271">
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/site">
		<xsl:if test="count(*[@id]) &gt; 0">
			<div class="shop-top" style="background-image: url('/hostcmsfiles/assets/images/slider/slider2.jpg');">
				<div class="container">
					<div class="breadcrumbs shop-breadcrumbs">
					...
					<!-- Последний элемент -->
					<h1 class="shop-title"><xsl:value-of select="(//*/name)[last()]"/></h1>
				</div>
			</div>
		</xsl:if>
	</xsl:template>
