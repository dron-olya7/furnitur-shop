	...
	<xsl:template match="shop_item">
		...
		<div class="product">
			...
			<div class="product-icons">
				...
				<div id="wishlist{@id}" class="icon icon-favorite" onclick="return $.addFavorite('{/shop/url}favorite/', {@id}, this)">
				...
				<a title="{name}" href="{url}">
					<xsl:choose>
						...
						<xsl:when test="modification_id and shop_item/image_small != ''">
							<img alt="{name}" title="{name}" data-src="{shop_item/dir}{shop_item/image_small}" class="lazyload"/>
						</xsl:when>
