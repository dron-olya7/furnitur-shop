			...
			<div class="box-user-content no-margin-top">
				<div class="user-tickets">
					...
					<div class="row mb-3 align-items-center">
						...
						<div class="col-12 col-sm-6 user-tickets-add-link">
							<a class="btn btn-sm" href="#" onclick="$('#AddTicket').toggle('slow'); return false"><i class="fa fa-plus"></i>Направить запрос</a>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12 helpdesk-worktime">
							<a class="btn btn-fifth btn-sm" href="{url}worktime/">Режим работы</a>
						</div>
					</div>
				</div>
			</div>
	...
	<xsl:template name="AddTicketForm">
		...
		<form action="{/helpdesk/url}" class="show form" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				<xsl:if test="helpdesk_criticality_level/node()">
					<div class="form-group col-12 col-md-6">
						...
						<select name="criticality_level_id" class="wide">
				...
				<xsl:if test="helpdesk_category/node()">
					<div class="form-group col-12 col-md-6">
						...
						<select name="helpdesk_category_id" class="wide">
			...
			<div class="row">
				<div class="form-group col-12">
					<!-- <div>
						<label class="checkbox-inline" for="maillist_{@id}">
							<input id="send_email" type="checkbox" checked="checked" name="send_email" />
							<span>Отсылать ответы на e-mail</span>
						</label>
					</div> -->

					<div class="pretty p-default p-pulse mb-3">
						<input type="checkbox" id="send_email" checked="checked" name="send_email" />
						<div class="state p-primary-o">
							<label>Отсылать ответы на e-mail</label>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="field">
					<div class="input-group">
						...
						<div class="directory-actions" style="margin-top: 0;">
							<span class="input-group-addon green-text add-file" href="#" id="addFile">
			...
			<button type="submit" class="btn mb-4" name="add_ticket" value="add_ticket">Отправить</button>
		</form>
	</xsl:template>
